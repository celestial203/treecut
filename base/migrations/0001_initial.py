    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.CharField(choices=[('Molave', 'Molave'), ('Molave SL', 'Molave SL'), ('Molave Fuel Wood', 'Molave Fuel Wood'), ('Germelina', 'Germelina'), ('Germelina SL', 'Germelina SL'), ('Germelina Fuel Wood', 'Germelina Fuel Wood'), ('Mahogany', 'Mahogany'), ('Mahogany SL', 'Mahogany SL'), ('Mahogany Fuel Wood', 'Mahogany Fuel Wood'), ('Narra', 'Narra'), ('Narra SL', 'Narra SL'), ('Narra Fuel Wood', 'Narra Fuel Wood')], default='Molave', max_length=100)),
